/**
 /**
  * Serialises an array of interleaved shards into a bitstream.
  ...
  * @param interleadShards The array of interleaved shards to be serialised
  * @returns The serialised bitstream
  */
